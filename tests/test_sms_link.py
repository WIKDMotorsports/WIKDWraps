...
def run(playwright):
    ...
    # Wait for scramble code to finish (about 1 second + buffer)
    page.wait_for_timeout(3000)

    # Force click "Claim Your Discount" because it has CSS transforms that make it unstable for normal click
    ...
    print("test.html SMS button is correctly rendered as a BUTTON tag and is clickable.")
