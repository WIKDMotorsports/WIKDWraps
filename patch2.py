...
def update_file(filename):
    ...
    if "justify-content: flex-start;" not in content:
        content = content.replace("        @media (max-width: 768px) {", new_css)

    # 3. Swap image with <picture> tag
    img_tag = '<img src="https://cdn.shopify.com/s/files/1/0648/4826/5421/files/Freshly_Detailed_Ryft_McLaren_720s_on_HRE_Wheels_with_WIKD_Exhaust.jpg?v=1744062350" class="fade-image active" alt="Hero Background">'
    img_tag2 = '<img src="https://cdn.shopify.com/s/files/1/0648/4826/5421/files/Freshly_Detailed_Ryft_McLaren_720s_on_HRE_Wheels_with_WIKD_Exhaust.jpg?v=1744062350" class="fade-image active" alt="Hero Background">'
